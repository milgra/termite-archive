    ...
    void                settings_init( char* path , char* name );
    void                settings_free( void );
    void                settings_reset( void );
    void                settings_del( char* key );
    void                settings_set( char* key , type_container_t* value );
    void                settings_setint( char* key , int value );
    void                settings_setfloat( char* key , float value );
    void                settings_setstring( char* key , mtstr_t* value );
    void                settings_setunsigned( char* key , uint32_t value );
    type_container_t*   settings_get( char* key );
    int                 settings_getint( char* key );
    float               settings_getfloat( char* key );
    mtstr_t*            settings_getstring( char* key );
    uint32_t            settings_getunsigned( char* key );
