...
//
    ...
    void control_updateselection( 	v3_t pointA ,
    								v3_t pointB );
    ...
    void control_createselection( )
    {
        ...
        SET( control.vox_rect , selection );
	...
	v4_t control_touchup( void* data , m4_t matrix )
	{
        ...
        if ( diff < 200000 )
        {
        	result = v4_init( 0.0 ,
                              0.0 ,
                              control.vox_base->model.w ,
                              control.vox_base->model.h );
		}
        else if ( control.lasttouch.x != 0 && control.lasttouch.y != 0 )
        {
        	result = v4_init( control.vox_rect->model.x ,
                             -control.vox_rect->model.y ,
                              control.vox_rect->model.w + control.vox_rect->model.x ,
                              control.vox_rect->model.h - control.vox_rect->model.y );
        }
